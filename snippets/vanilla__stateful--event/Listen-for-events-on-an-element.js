...
/**
 * Certain events, like focus, don’t bubble.
 * In order to use event delegation with events that don’t bubble,
 * you can set an optional third argument
 * on the EventTarget.addEventListener() method, called useCapture, to true.
 */
