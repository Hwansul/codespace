 ...
 *
 * 1. The first,
 *    start, is the index of the item you want to modify in the array.
 *    It’s the only required argument.
 *
 * 2. The second,
 *    delete, is the number of items to delete from the array.
 *    If you omit this argument, the Array.splice() method will remove every item from the start index on.
 *    If you set it to 0, it won’t remove any items.
 *
 * 3. Finally,
 *    if you want to insert one or more items into the array,
 * you can pass them in as additional arguments.
 */
